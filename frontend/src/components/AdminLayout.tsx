...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background text-on-background font-sans selection:bg-primary/30">
      {/* TopAppBar */}
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-outline-variant px-6 lg:px-10 py-3 bg-surface/80 backdrop-blur-md sticky top-0 z-50">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4 text-primary">
            ...
            <h2 className="text-white text-lg font-bold leading-tight tracking-[-0.015em]">GrievAI Admin</h2>
          </div>
        ...
        <div className="flex flex-1 justify-end gap-4 lg:gap-8">
          <div className="flex gap-2">
            <button className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-surface-container text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5 hover:bg-surface-variant transition-colors">
